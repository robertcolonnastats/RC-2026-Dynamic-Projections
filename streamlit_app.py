...
Key Updates:
- FIXED COMPRESSION: Reduced Pythag Regression (130 -> 50) and Luck Regression (Disabled).
- INCREASED TRUST: Max Projection Weight increased to 0.95.
- REMOVED CAPS: Removed .clip(0.20, 0.80) to allow elite teams to project >90 wins.
"""
...
# ==============================================================================
# CONSTANTS - FIXED FOR SPREAD & VARIANCE
# ==============================================================================
SEASON_YEAR = 2026
...
CACHE_VERSION = "v43-fix-compression"
...
PYTHAG_REGRESSION_PA = 50   # Was 130. Lower = trust record more.

# 🔴 FIX 2: Increased Trust in Talent
PROJ_WEIGHT_MAX = 0.95      # Was 0.90. Trust PECOTA more.
