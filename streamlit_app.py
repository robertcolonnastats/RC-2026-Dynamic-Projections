...
DOWNSIDE PENALTY: Added extra penalty for sub-.500 talent teams.
"""
...
def fetch_team_projections(standings_df, roster_map):
    ...
    for tid in all_ids:
        try:
            ...
            # ==============================================================================
            # EXTRA DOWNSIDE PENALTY FOR WEAK TEAMS
            # ==============================================================================
            # PURPOSE:
            # Allow terrible teams to collapse more realistically without hurting elite teams.
