...
ADDED: Park Factor adjustments to regress extreme parks (Coors, Chase Field).
ADDED: Dynamic Pythagorean regression (130 -> 30) in build_master.
"""
...
opts = sorted([(r["name"], int(r["team_id"])) for  , r in mdf.iterrows()])
