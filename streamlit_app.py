...
Key Updates:
- FIXED DATA MAPPING: Expanded PECOTA_TEAM_MAP to handle Full Team Names (e.g., "Los Angeles Dodgers")
- FIXED TIMING: Buyer/Seller status now strictly neutral until May 20 (using get_deadline_ramp_factor)
...
# ==============================================================================
# CONSTANTS - UPDATED WEIGHTS & EXPANDED MAP
# ==============================================================================
SEASON_YEAR = 2026
...
CACHE_VERSION = "v38-expanded-map-fix"
...
# FIXED: Expanded Map to handle Full Team Names from Excel
PECOTA_TEAM_MAP = {
...
def _load_pecota_data():
    ...
    try:
        if os.path.exists(hit_file) and os.path.exists(pit_file):
            ...
            # FIX: Robust Cleaning - Strip spaces and force uppercase to match the Map
            ...
            # Map to team IDs using the expanded map
...
def compute_buyer_seller(df):
    ...
    # FIX: Use strict deadline ramp factor (0.0 until May 20) to prevent early Soft Seller tags
