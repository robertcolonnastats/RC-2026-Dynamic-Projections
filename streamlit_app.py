...
PRIOR_HIST_2025_WEIGHT = 0.40
PRIOR_HIST_2024_WEIGHT = 0.10

STATCAST_INFLUENCE = 1.50
ROSTER_WEIGHT_ACTIVE = 650.0
ROSTER_WEIGHT_IL = 250
ROSTER_WEIGHT_OTHER = 300.0
TYPICAL_TEAM_WARP = 35.0
MAX_IL_FRAC = 0.20
PYTHAG_REGRESSION_PA = 81
PROJ_WEIGHT_MAX = 0.95
PROJ_WEIGHT_MIN = 0.10
TIER_HARD_SELLER = 4.2
TIER_SOFT_SELLER = 3.2
TIER_SOFT_BUYER = -3.0
TIER_HARD_BUYER = -8.5
RD_SENSITIVITY = 0.040
RD_DAMPENER_START_GP = 70
LUCK_SENSITIVITY = 1.20
LUCK_DAMPENER_START_GP = 40
LUCK_REGRESSION_FACTOR = 0.70
...
def _load_pecota_data():
    ...
    try:
        if os.path.exists(hit_file) and os.path.exists(pit_file):
            ...
            st.warning("📂 Excel files not found. Using fallback data.")
